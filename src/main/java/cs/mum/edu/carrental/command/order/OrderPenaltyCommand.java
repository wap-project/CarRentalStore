...
public class OrderPenaltyCommand extends CommandTemplate {
    private static final Logger logger = LoggerFactory.getLogger(OrderPenaltyCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (orderDao.changePenalty(orderId, penalty)) {
